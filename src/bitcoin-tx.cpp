...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " monkycoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  monkycoin-tx [options] <hex-tx> [commands]  Update hex-encoded monkycoin transaction\n" +
            "or:     monkycoin-tx [options] -create [commands]   Create hex-encoded monkycoin transaction\n" +
            "\n";
