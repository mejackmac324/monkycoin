...
"""Verify that starting monkycoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start monkycoin with -h for help text")
        ...
        self.log.info("Start monkycoin with -version for version information")
        ...
        self.log.info("Start monkycoind with -fakearg to make sure it does not start")
