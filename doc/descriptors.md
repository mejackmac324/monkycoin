# Support for Output Descriptors in monkycoin Core

Since monkycoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `MNC1...` for mainnet or `tMNC1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on monkycoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing monkycoin Core wallets, a convenience function `combo` is
